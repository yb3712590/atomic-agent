...
| `P2-005-openai-compatible-provider-options-hardening-spec.md` | draft | 定义 P2-005 OpenAI-compatible provider options hardening（OpenAI 兼容供应商参数硬化）的范围和验收标准 | 细化 P2-005 plan 或实施前 |
